...
<div @click="$dispatch('edit-employee', { id: {{ $id }} })" data-id="{{ $id }}" class="cursor-pointer bg-tidewater hover:-translate-y-2 transition-transform rounded-lg p-4 mt-4" style="background-color: #1a3333; border: 1px solid #DAA520;">
