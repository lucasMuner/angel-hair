...
>
    ...
    >
        ...
        >
            ...
            <form>
                <div class="mb-4">
                    <x-input-field label="Nome" id="name" name="name" placeholder="Digite o nome do cliente" />
                </div>

                <div class="mb-4">
                    <x-input-field label="Email" id="email" name="email" type="email" placeholder="Digite o email do cliente" />
                </div>

                <div class="mb-4">
                    <x-input-field label="Telefone" id="phone" name="phone" placeholder="Digite o telefone do cliente" />
                </div>
