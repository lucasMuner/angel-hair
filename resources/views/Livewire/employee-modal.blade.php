    ...
    >
        ...
        >
            ...
            <form  wire:submit.prevent="save">
                <div class="mb-4">
                    <x-input-field label="Nome" id="name" name="name" wire:model="name" placeholder="Digite o nome do funcionário" />
                </div>

                <div class="mb-4">
                    <x-input-field label="Email" id="email" name="email" type="email" wire:model="email" placeholder="Digite o email do funcionário" />
                </div>

                <div class="mb-4">
                    <x-input-field label="Telefone" id="phone" name="phone" wire:model="phone" placeholder="Digite o telefone do funcionário" />
                </div>
